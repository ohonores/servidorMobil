var scritpA = "CREATE TABLE #TABLA (id integer primary key, hash TEXT, #COLUMNAS)";
var scritpEspejo = "CREATE TABLE IF NOT EXISTS #TABLA (id integer primary key, #COLUMNAS)";
var scritpDropTables = "DROP TABLE #TABLA";
